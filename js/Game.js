class Game extends Phaser.Scene {
	...
	preload() {
		...
		if (randomClass == 1) {
			randomClass = 'assets/player/warrior.png';
		} else if (randomClass == 2) {
			randomClass = 'assets/player/mage.png';
		} else {
			randomClass = 'assets/player/ranger.png';
		}
		this.load.spritesheet('player', randomClass, { frameWidth: 32, frameHeight: 36 });
	};
	...
	addMainPlayer(id, x, y) {
		this.playerClass = new Player({ id: id, scene: this, x: x, y: y, key: 'player' });
